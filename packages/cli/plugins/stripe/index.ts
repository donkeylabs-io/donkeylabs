...
declare module "@donkeylabs/server" {
  interface ErrorFactories {
    CustomerNotFound: ErrorFactory;
    SubscriptionNotFound: ErrorFactory;
    SubscriptionRequired: ErrorFactory;
    PaymentFailed: ErrorFactory;
    WebhookVerificationFailed: ErrorFactory;
    StripeApiError: ErrorFactory;
    CheckoutNotConfigured: ErrorFactory;
    PortalNotConfigured: ErrorFactory;
  }
}
...
export const stripePlugin = createPlugin
  ...
  .define({
    ...
    events: {
      "stripe.customer.created": z.object({
        userId: z.string(),
        stripeCustomerId: z.string(),
      }),
      "stripe.subscription.created": z.object({
        userId: z.string(),
        subscriptionId: z.string(),
        productId: z.string(),
        status: z.string(),
      }),
      "stripe.subscription.updated": z.object({
        userId: z.string(),
        subscriptionId: z.string(),
        status: z.string(),
        previousStatus: z.string(),
      }),
      "stripe.subscription.canceled": z.object({
        userId: z.string(),
        subscriptionId: z.string(),
        endsAt: z.string(),
      }),
      "stripe.payment.succeeded": z.object({
        userId: z.string(),
        amount: z.number(),
        currency: z.string(),
      }),
      "stripe.payment.failed": z.object({
        userId: z.string(),
        error: z.string(),
      }),
      "stripe.trial.ending": z.object({
        userId: z.string(),
        subscriptionId: z.string(),
